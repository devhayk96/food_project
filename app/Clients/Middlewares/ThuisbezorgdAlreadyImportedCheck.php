...
class ThuisbezorgdAlreadyImportedCheck extends AbstractOrderMiddleware
{
    ...
    {
        try {
            $order = Order::whereJsonContains('order_json', ['orderKey'=> $orderInTransit->raw['orderKey']])->firstOrFail();
