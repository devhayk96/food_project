        ...
        <v-card height="100%" width="100%">
            <v-form ref="form">
                <v-card-title class="text-capitalize">
                    {{ this.dataDetails.id >0? 'Edit': 'Add' }} Order Status
                </v-card-title>
                    ...
                    <v-row>
                        ...
                        <v-col cols="12" md="12">
                            <v-select
                                ...
                                name="parent"
                                prepend-icon="mdi-select"
                                :loading="orderStatusList === ''"
                                :items="_.map(orderStatusList, ((cat)=>{ return cat.parent_id === null?{text: cat.name,value: cat.id}: {text:'None', value:null}}))"
    ...
    export default {
        ...
        data() {
            return {
                ...
                savePermission: 'order_statuses-create'
            }
        },
        created() {
        ...
        mounted() {
            ...
            if(this.dataDetails.id>0){
                this.savePermission = 'order_statuses-update';
                this.fetchDetails();
            }
        ...
        methods: {
            ...
            fetchOrderStatusList: function () {
                ...
                axios.get('/web/v1/order-statuses')
                    .then(function (response) {
                        console.log(response);
                        _this.orderStatusList = response.data.data;
                    })
                    .catch(function (resp) {
                        console.log(resp);
                    });
            ...
            fetchDetails: function () {
                const _this = this;
                axios.get('/web/v1/order-statuses/'+this.dataDetails.id)
                    .then(function (response) {
                        console.log(response);
            ...
            addData: function () {
                ...
                axios.post('/web/v1/order-statuses', this.dataDetails)
                    .then(function (response) {
                        console.log(response);
                        if(response.data) {
                            ...
                            _this.$router.push({name:'dashboard-operations-order-statuses'});
                        }
                        else{
            ...
            updateData: function () {
                ...
                axios.put('/web/v1/order-statuses/' + this.dataDetails.id, this.dataDetails)
                    .then(function (response) {
                        console.log(response);
                        if(response.data) {
                            _this.showSuccess('Data is updated.');
