        ...
        <v-card height="100%" width="100%">
            <v-form ref="form">
                <v-card-title class="text-capitalize">
                    {{ this.dataDetails.id >0? 'Edit': 'Add' }} Courier Type
                </v-card-title>
                    ...
                    <v-row>
                        ...
                        <v-col cols="12" md="12">
                            <v-select
                                ...
                                name="parent"
                                prepend-icon="mdi-select"
                                :loading="courierTypeList === ''"
                                :items="_.map(courierTypeList, ((cat)=>{ return cat.parent_id === null?{text: cat.name,value: cat.id}: {text:'None', value:null}}))"
    ...
    export default {
        ...
        data() {
            return {
                ...
                savePermission: 'courier_types-create'
            }
        },
        created() {
        ...
        mounted() {
            ...
            if(this.dataDetails.id>0){
                this.savePermission = 'courier_types-update';
                this.fetchDetails();
            }
            this.fetchSourceTypeList();
            this.fetchCourierTypeList();
        },
        ...
        methods: {
            ...
            fetchCourierTypeList: function () {
                const _this = this;
                axios.get('/web/v1/courier-types')
                    .then(function (response) {
                        console.log(response);
                        _this.courierTypeList = response.data.data;
                    })
                    .catch(function (resp) {
                        console.log(resp);
                    });
            ...
            fetchDetails: function () {
                const _this = this;
                axios.get('/web/v1/courier-types/'+this.dataDetails.id)
                    .then(function (response) {
                        console.log(response);
            ...
            addData: function () {
                ...
                axios.post('/web/v1/courier-types', this.dataDetails)
                    .then(function (response) {
                        console.log(response);
                        if(response.data) {
                            ...
                            _this.$router.push({name:'dashboard-operations-courier-types'});
                        }
                        else{
            ...
            updateData: function () {
                ...
                axios.put('/web/v1/courier-types/' + this.dataDetails.id, this.dataDetails)
                    .then(function (response) {
                        console.log(response);
                        if(response.data) {
                            _this.showSuccess('Data is updated.');
