<template>
    <div>
        <v-list-item
            v-if="!menuItem.items && userCan(menuItem.permissions)"
        ...
        >
            ...
            <v-list-item-content>
                <v-list-item-title>
                    ...
                    <v-badge v-if="menuItem.text == 'New' && newOrderCount>0" bordered class="ml-1" :content="newOrderCount"
                    ></v-badge>
                </v-list-item-title>
            </v-list-item-content>
        </v-list-item>
        ...
        <v-list-group
            v-else-if="userCan(menuItem.permissions)"
